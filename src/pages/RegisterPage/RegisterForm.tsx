...
import logo from '../../assets/images/logo.svg';import { UserInterface } from './user';
...
const RegisterForm = () => {
  ...
  const formSubmit: SubmitHandler<UserInterface> = async (
    data: UserInterface
  ) => {
    const { email, fullname, username, password } = data;
    setLoading(true);
    alert({ email, password, fullname, username });
  ...
  return (
    <>
      ...
      <Box component='p' className={classes.mutedText}>
        ...
        collect, use and share your data in our <strong>Data Policy</strong>,
